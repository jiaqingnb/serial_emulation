...
#ifndef SFPPLATFORM_H
#define SFPPLATFORM_H
...
* 返回值        : 正常初始化返回1，否则返回0       
*******************************************************************************************/
    UINT8 ProtclInit(UINT8* fileName, UINT32 inDataLen, UINT8 inData[], struc_Unify_Info* pUnifyInfo);
...
*函数名:	SfpDelAllLink
*功能描述:	SFP删除所有链路
*输入参数:	struc_Unify_Info* spf SFP结构体变量
*输入出参:	无
*输出参数:	无
*返回值:	无
*/
void SfpDelAllLink(struc_Unify_Info* spf);
