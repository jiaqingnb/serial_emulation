...
#ifndef RSSP_LNK_NODE_MGR_WL_H
#define RSSP_LNK_NODE_MGR_WL_H
 ...
 *
 ***********************************************************************/
UINT8 outputReplaceLnkNode_WL(UINT16 SrcAddr,UINT16 BsdAddr,UINT16 DestAddr,UINT32 LocalDevName,Lnk_Info_Node_Stru_WL **pPLnkNodeInfo,RSSP_INFO_STRU *pRsspStruct);
