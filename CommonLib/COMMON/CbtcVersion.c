...
*修改记录:
*1、修复集成测试缺陷QC-1811,数据转换问题,Baix,2020-04-13;
*/
void VerFromU32SoftwareModule(UINT16 *pProductNo,UINT16 *pModuleNo,UINT16 *pMainVer,UINT16 *pSubVer,UINT32 u32Ver)
{
	if((NULL != pProductNo) && (NULL != pModuleNo) && (NULL != pMainVer) && (NULL != pSubVer))
	{
		*pProductNo = (UINT16)(u32Ver>>24);
		*pModuleNo = (UINT16)((u32Ver&0x00FFC000)>>14);
		*pMainVer = (UINT16)((u32Ver&0x00003F00)>>8);
		*pSubVer = (UINT16)(u32Ver&0x000000FF);
	}
}
