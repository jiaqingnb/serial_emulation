...
#ifndef CBTCVERSION_H
#define CBTCVERSION_H
...
extern "C" {
	...
	/*yt增加-2021-07-14，内部版本号*/
#define VER_SOFT_PROJECT           209
#define VER_SOFT_MODUAL            50
#define VER_SOFT_MIANSOFT           1
#define VER_SOFT_SUBSOFT            5
