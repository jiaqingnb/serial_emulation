...
#define DQU_DFS_VER1	66u	/*产品编号*/
#define DQU_DFS_VER2	19u	/*软件模块编号*/
#define DQU_DFS_VER3	0u	/*软件模块主版本编号*/
#define DQU_DFS_VER4	2u	/*软件模块子版本编号*/

#define  DFS_DATA_INDEX_NUM		100u						/*预留文件头的个数 m by sds 2018-11-19*/  
#define  DFS_MAX_FILE_LEN		(UINT32)(6u*1024u*1024u)	/*最大支持的文件长度（6M）*/

#define  DFS_DH_SPARE_BYTE_LENGTH	20u						/*预留字节长度*/
#define  DFS_DI_SPARE_BYTE_LENGTH	8u						/*预留字节长度*/
#define  DATA_CONTENT_MALLOC_SIZE	0x200000u
/*文件读取失败错误码*/
#define LOAD_FILE_READ_ERR			0X00000001u				/*文件打开失败*/
#define LOAD_FILE_LENGTH_ERR		0X00000002u				/*文件读取长度错误*/
#define  DFS_VERSION_LENGTH			4u						/*版本号长度*/

#define  DFS_DATA_HEAD_SIZE			40u						/*文件头大小*/
#define  DFS_DATA_INDEX_SIZE		24u						/*主文件头大小*/
/*20160316新增互联互通相关宏定义*/
#define READ_LENGTH_ONCE			2236u					/*一次读取数据的长度*/

#define LENGTH_OF_READ				3266u					/*一次读取数据的长度*/
#define LENGTH_OF_WRITE				3266u					/*一次写入的长度*/
#define READ_MODE_ONCE				1u						/*一次性读取模式*/
#define READ_MODE_TIMES				2u						/*拆分多次读取函数*/
/*****故障码宏定义******/

#define ERR_FILE_READ				0x0001u					/*读取文件失败*/
#define ERR_FILE_LENTH				0x0002u					/*文件长度有误*/
#define ERR_CRC_CHECK				0x0004u					/*CRC校验失败*/

#define ERR_DATA_TYPE				0x0001u					/*数据类型错误*/
#define ERR_DATA_ID					0x0002u					/*数据ID错误*/
#define ERR_PTR_NULL				0x0003u					/*数据指针为空*/
/*****故障码宏定义结束****/
