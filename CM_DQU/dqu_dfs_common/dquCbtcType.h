...
#define DQU_CBTC_FAO	1u		/*全自动驾驶系统*/
#define DQU_CBTC_CPK	2u		/*合库系统*/
#define DQU_CBTC_HLT	3u		/*互联互通系统*/
#define DQU_CBTC_DG     4u		/*单轨系统 add by qxt 20170621*/
#define DQU_CBTC_CC     5u		/*车车系统 add by sds 2019-6-13*/

#define DQU_QFUN_TRUE	0x55u	/*函数为可用*/
#define DQU_QFUN_FASLE  0xAAu	/*函数为不可用*/
