...
#define POINT_NUM_MAX				100u				/*道岔序列最大长度*/
#define LINK_NUM_MAX				50u					/*Link序列最大长度*/
#define OBJECT_NUM_MAX				500u				/*对象序列最大长度*/
#define COMMOC_NUM_MAX				(UINT8)5u			/*列车通信OC最大数量*/
...
typedef struct {
	...
	UINT8	RlatedExistTag;			/*道岔有关联道岔标志*/
