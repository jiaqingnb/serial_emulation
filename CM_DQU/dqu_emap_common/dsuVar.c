...
static UINT16 g_dsuEmapDataArrayLen[DFS_DATA_INDEX_NUM] = { 0u };	/*用于存储电子地图中各项数据项数组的个数*/
static UINT16 g_dsuEmapIndexArrayLen[DFS_DATA_INDEX_NUM] = { 0u };	/*用于存储电子地图中各项索引数组的个数*/
