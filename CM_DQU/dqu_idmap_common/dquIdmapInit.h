...
#define  INIT_IDMAP_ERR_NUM   20u		/*修改by slm 2019.1.16*/
...
#define DQU_ROW_LEN_IDMAP_ZC			6U			/*ZC表每行字节数*/
#define DQU_ROW_LEN_IDMAP_CI			6U			/*CI表每行字节数*/
#define DQU_ROW_LEN_IDMAP_ATS			6U			/*ATS表每行字节数*/
#define DQU_ROW_LEN_IDMAP_SIGNAL		6U			/*信号机表每行字节数*/
#define DQU_ROW_LEN_IDMAP_TRACKSEC		124U		/*轨道区段表每行字节数*/
#define DQU_ROW_LEN_IDMAP_SWITCH		6U			/*道岔表每行字节数*/
#define DQU_ROW_LEN_IDMAP_STATION		6U			/*逻辑站台表每行字节数*/
#define DQU_ROW_LEN_IDMAP_EMERGBTN		6U			/*ESB表每行字节数*/
#define DQU_ROW_LEN_IDMAP_BALISE		6U			/*应答器表每行字节数*/
#define DQU_ROW_LEN_IDMAP_PSD			6U			/*PSD表每行字节数*/
#define DQU_ROW_LEN_IDMAP_VOBC			10U			/*VOBC表每行字节数*/
#define DQU_ROW_LEN_IDMAP_FPD			6U			/*防淹门表每行字节数*/
#define DQU_ROW_LEN_IDMAP_DSU			6U			/*DSU表每行字节数*/
#define DQU_ROW_LEN_IDMAP_LOGICSEC		6U			/*逻辑区段表每行字节数*/
#define DQU_ROW_LEN_IDMAP_AOM			10U			/*AOM表每行字节数*/
#define DQU_ROW_LEN_IDMAP_SPKS			6U			/*SPKS表每行字节数*/
#define DQU_ROW_LEN_IDMAP_GOD			6U			/*车库门表每行字节数*/
#define DQU_ROW_LEN_IDMAP_STA			6U			/*车站表每行字节数*/
#define DQU_ROW_LEN_IDMAP_PHY			6U			/*物理区段表每行字节数*/
#define DQU_ROW_LEN_IDMAP_TSL			6U			/*TSL表每行字节数*/
