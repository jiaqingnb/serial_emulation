...
#ifndef DSU_IDMAP_QUERY_H
#define DSU_IDMAP_QUERY_H
...
#define QFUN_IDMAP_ZC_ID			1u		/*ZC编号数据ID*/
#define QFUN_IDMAP_CI_ID			2u		/*TIOC编号数据ID*/
#define QFUN_IDMAP_ATS_ID			3u		/*ATS编号数据ID*/
#define QFUN_IDMAP_SIGNAL_ID		4u		/*信号机编号数据ID*/
#define QFUN_IDMAP_TRACKSEC_ID		5u		/*轨道区段编号数据ID*/
#define QFUN_IDMAP_SWITCH_ID		6u		/*道岔编号数据ID*/
#define QFUN_IDMAP_STATION_ID		7u		/*逻辑站台编号数据ID*/
#define QFUN_IDMAP_EMERGBTN_ID		8u		/*紧急关闭按钮编号数据ID*/
#define QFUN_IDMAP_BALISE_ID		9u		/*应答器编号数据ID*/
#define QFUN_IDMAP_PSD_ID			10u		/*屏蔽门编号数据ID*/
#define QFUN_IDMAP_VOBC_ID			11u		/*VOBC编号数据ID*/
#define QFUN_IDMAP_FPD_ID			12u		/*屏蔽门编号数据ID*/
#define QFUN_IDMAP_DSU_ID			13u		/*DSU编号数据ID*/
#define QFUN_IDMAP_LOGICSEC_ID		14u		/*逻辑区段编号数据ID*/
#define QFUN_IDMAP_AOM_ID			15u		/*AOM编号数据ID*/
#define QFUN_IDMAP_SPKS_ID			16u		/*SPKS编号数据ID*/
#define QFUN_IDMAP_GOD_ID			17u		/*车库门编号数据ID*/
#define QFUN_IDMAP_STA_ID			18u		/*车站编号数据ID*/
#define QFUN_IDMAP_PHY_ID			19u		/*物理区段编号数据ID*/
#define QFUN_IDMAP_TSL_ID			20u		/*TSL编号数据ID*/

#define IDMAP_TYPE_MIN				1u		/*查询结构类型最小值 add by qxt 20170509*/
#define IDMAP_TYPE_MAX				20u		/*查询结构类型最大值，用于防护查询类型struType的范围*/

#define DQU_IDMAP_INIT_TRUE			0x55u
#define DQU_IDMAP_INIT_FALSE		0xAAu
